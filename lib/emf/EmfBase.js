...
class EmfBase extends EventEmitter {
  ...
  static get DefaultOptions() {
    return {
      ...
      // Warning! Some versions of BLAS and LAPACK utilizes all threads by default
      //  (what versions?) (it depends on options they are compiled with)
      // When they are using all threads, 2 processes works much slower that 1 
      //  (because of context switch?)
      // So don't set numThreadsForTrain.als > 1 in this case
      numThreadsForTrain: { als: numCPUs, sgd: 1 }, 
